...
import datetime
import webbrowser
from mood import (happy_list, sad_list, angry_list, suicidal_list, depressed_list, general_responses, sad_mood_responses, angry_mood_responses, happy_mood_responses, suicidal_mood_responses, depressed_mood_responses)
