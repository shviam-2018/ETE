...
if __name__ == "__main__":
    ...
    while True:
        ...
        elif "bye" in query or "close" in query:   # Corrected condition
            print("Goodbye! Have a great day!")
            speak("Goodbye! Have a great day!")
            break

        else:
            print("I am sorry, but I can't seem to help you with that.")
            speak("I am sorry, but I can't seem to help you with that.")
